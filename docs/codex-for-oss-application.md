...
API credits would power optional maintainer automation: PR summaries, issue deduplication, release note drafts, security review checklists, and regression-test repair suggestions. All outputs would be review-only and controlled by maintainers.

## Anything else

I am building this as a public, permissively licensed maintainer tool with CI, tests, security policy, issue templates, and a documented roadmap. I plan to publish releases, collect adoption signals, and keep all automation auditable.
